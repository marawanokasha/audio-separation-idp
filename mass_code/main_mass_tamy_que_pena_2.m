...
saveDirectory = strcat('final/mass/tamy_que_pena_2/','T_',int2str(T),'_D1_',int2str(dictionaryAtomsX1),'_D2_',int2str(dictionaryAtomsX2),'_Npad_',int2str(Npad),'_nIter_',int2str(numberOfIterations),'_fs_',int2str(fs),'/');
