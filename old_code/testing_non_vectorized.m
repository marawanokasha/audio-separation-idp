...
%% Loading the scatts (just for stds1 and stds2)

load('saved_scatts/scatt_n500_non_vectorized_X1_X2_male_speaker_s1.mat')
stds11 = stds1;
stds21 = stds2;
clear X1 X2 stds1 stds2
...
load('saved_dicts/dict_n500_non_vectorized_male_speaker_s1.mat')

Dnmf11 = Dnmf1;
Dnmf21 = Dnmf2;
clear Dnmf1 Dnmf2

load('saved_dicts/dict_n500_non_vectorized_female_speaker_s7.mat')
...
%% Loading Bruna's data ( Not to be used with previous)

load('pretrained_dics/dictionaries_NMF_scatt2_s1.mat')
Dnmf11 = Dnmf1;
Dnmf21 = Dnmf2;
clear Dnmf1 Dnmf2

load('pretrained_dics/dictionaries_NMF_scatt2_s7.mat')
Dnmf12 = Dnmf1;
Dnmf22 = Dnmf2;
clear Dnmf1 Dnmf2
