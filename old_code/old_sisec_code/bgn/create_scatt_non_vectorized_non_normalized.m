...
dataDirectory = '/home/marawan/workspace/matlab/idp/data/sisec/bgn';
...
%%
save('sisec_code/saved_dicts/bgn/speakers_all_resampled.mat', 'speakers')
...
%     save(strcat('saved_scatts/scatt_n500_X1_X2_', speakers(i).type, '_speaker_', speakers(i).name),'X1', 'X2', 'stds1all', 'stds2all')
    save(strcat('sisec_code/saved_scatts/bgn/scatt_all_non_vectorized_non_renorm_X1_X2_', speakers(i).type, '_speaker_', speakers(i).name),'X1', 'X2')
%     break
end
