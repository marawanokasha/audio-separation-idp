...
Dnmf1_list = {Dnmf11, Dnmf12};
Dnmf2_list = {Dnmf21, Dnmf22};
...
%% evaluate results
Parms_scatt2  =  BSS_EVAL(x1', x2', speech_list{1}(1:T)', speech_list{2}(1:T)', mix');
Parms_scatt1 =  BSS_EVAL(x1', x2', xest_list{1}(1:T)', xest_list{2}(1:T)', mix');
