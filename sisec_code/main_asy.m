...
dataDirectory = '../data/sisec/asy';
saveDirectory = strcat('final/sisec/asy/','T_',int2str(T),'_D1_',int2str(dictionaryAtomsX1),'_D2_',int2str(dictionaryAtomsX2),'_Npad_',int2str(Npad),'_fs_',int2str(fs),'/');
...
testDirectory = '../data/sisec/asy/test/';

testFileName = 'test_male2_300ms_mix_ch34.wav';
...
[Dnmf12, Dnmf22] = get_dictionaries('m2', dictionariesSaveDirectory);
...
testFileName = 'test_male3_300ms_mix_ch56.wav';
file_path = strcat(testDirectory,testFileName); 
test_file_content = read_audio_processed(file_path,fs,Npad);
...
[Dnmf11, Dnmf21] = get_dictionaries('m1', dictionariesSaveDirectory);
[Dnmf12, Dnmf22] = get_dictionaries('m2', dictionariesSaveDirectory);
[Dnmf13, Dnmf23] = get_dictionaries('m3', dictionariesSaveDirectory);
...
testDirectory = '../data/sisec/asy/test/';
testSourcesDirectory = '../data/sisec/asy/test-speaker-sources/';
testNoisesDirectory = '../data/sisec/asy/test-noise-sources/';
