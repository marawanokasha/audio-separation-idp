...
%%% NMF Params
dictionaryAtomsX1 = 175; % must be less than or equal number of rows or cols
...
saveDirectory = strcat('final/sisec/bgn/','T_',int2str(T),'_D1_',int2str(dictionaryAtomsX1),'_D2_',int2str(dictionaryAtomsX2),'_nIter_',int2str(numberOfIterations),'_Npad_',int2str(Npad),'_fs_',int2str(fs),'/');
